...
59 registros com status "completed" em inglês foram substituídos por "Concluído", e 54 registros com forma_pagamento em letras maiúsculas foram normalizados para o formato título.
